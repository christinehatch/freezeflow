...
def tray_data(tray: Tray) -> dict[str, object]:
    ...
    return {
        ...
        "preparation_preset_id": tray.preparation_preset_id,
        "preparation_preset_name": tray.preparation_preset_name_at_use,
        "product_name": tray.product_name,
        "ingredients": tray.ingredients,
        "preparation_methods": tray.preparation_methods,
